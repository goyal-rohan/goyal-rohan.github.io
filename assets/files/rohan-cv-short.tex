...
I am broadly interested in theoretical computer science. In particular, I focus on notions of \\
robustness: error-correcting codes, expander graphs, proof systems etc.
%----------------------------------------------------------------------------------------
%	EDUCATION 
%----------------------------------------------------------------------------------------
...
{\bf Massachusetts Institute of Technology} \hfill September 2024-December 2025 (Expected)\\
...
\begin{list2}
    \item \textit{MIT CIS Seminar} {\hfill November 2025}
\end{list2}
